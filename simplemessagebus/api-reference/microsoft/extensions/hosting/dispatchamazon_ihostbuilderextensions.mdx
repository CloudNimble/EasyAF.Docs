---
title: "DispatchAmazon_IHostBuilderExtensions"
...
Configures SimpleMessageBus to use Amazon SQS as the backing queue and registers the <xref href="CloudNimble.SimpleMessageBus.Dispatch.Amazon.AmazonSQSProcessor" data-throw-if-not-resolved="false"></xref> with the DI container.
